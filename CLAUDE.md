...
- **`src/infrastructure/`** — external integrations:
  ...
  - `parsers/` — one file per ecosystem, registered in `parserRegistry.js` (npm, pip, Go, Cargo, Maven, Gradle + version catalogs, RubyGems, NuGet, Composer, Terraform, Swift, CocoaPods, Dart/Flutter, Docker, GitHub Actions)
